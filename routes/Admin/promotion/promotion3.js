...
connection.query(Data.promotion3Delete,function(err,rows){
  if(err){
  ...
  file.mv('public/img/promotion/Ads3/'+file.name, function(err) {
    var sql = "INSERT INTO `promotion3`(`promtion`) VALUES ('" + img_name + "')";
